...
function initVizLoss(){
  ...
  function draw(){
    ...
    $("loss-calc").innerHTML=(fn==="mse"?"MSE = (y−ŷ)² = ("+t.toFixed(2)+"−"+p.toFixed(2)+")²":"CE = −[y·log ŷ+(1−y)·log(1−ŷ)]")+
      "\nLoss = <b>"+L.toFixed(3)+"</b> "+(L<0.1?"✅ bagus, dekat target!":L<1?"😐 lumayan":"❌ masih jauh, geser ŷ ke "+t.toFixed(2));
  }
