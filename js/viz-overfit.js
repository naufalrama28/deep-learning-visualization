...
function initVizOverfit(){
  ...
  function draw(){
    ...
    var verdict=d<=1?"📉 UNDERFIT: terlalu lurus, dua-duanya jelek.":d<=5?"✅ PAS: mengikuti pola tanpa menghafal noise.":"📈 OVERFIT: meliuk-liuk menghafal noise, error uji meledak!";
    $("over-calc").innerHTML="Derajat "+d+" • Train MSE = <b>"+tr.toFixed(3)+"</b> • Test MSE = <b>"+te.toFixed(3)+"</b>\n"+verdict+"\nlegenda: hijau putus-putus=pola asli, biru=model, titik biru=latih, abu-abu=uji";
  }
